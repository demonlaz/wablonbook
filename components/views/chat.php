        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading" id="accordion">
                    <span class="glyphicon glyphicon-comment">  Комментарии к сайту</span>
                ...
                <div class="panel-collapse collapse" id="collapseOne">
                            ...
                            <li class="left clearfix"><span class="chat-img pull-left">
                             <i  alt="User Avatar" class="glyphicon glyphicon-user" /></i>
                                ...
                                <div class="chat-body clearfix">
                                    <div class="header">
                                        <strong class="primary-font" style="color: #ffa000;font-weight:800"><?=Html::encode($v['login'])?></strong> <small class="pull-right text-muted">
                                            <span class="glyphicon glyphicon-time"></span><?=Html::encode($v['timdate']); ?></small>
                                    </div>
                                    <p>
                                      <?=Html::encode($v['text'])?>
                                    </p>
                    ...
                    <div class="panel-footer">
                        ...
                        <?php
                        $form=ActiveForm::begin(['method'=>'post','action'=>['chat/index']
